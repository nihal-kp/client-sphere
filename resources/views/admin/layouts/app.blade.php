...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background: #fff;">
            ...
            <li class="nav-item {{ request()->is('admin/text-boxes') || request()->is('admin/text-boxes/*') ? 'active' : '' }}">
                <a class="nav-link" href="{{route('admin.text-boxes.index')}}">
                    <i class="fa fa-list"></i>
                    <span>Text Boxes</span></a>
            </li>
